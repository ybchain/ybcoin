...
static const int64 IPO_SHARES = 3000000 * COIN; // peershares: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 3000; // peershares: Block height of the last proof of work block

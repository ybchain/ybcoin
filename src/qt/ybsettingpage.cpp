    ...
    QWidget(parent)
{
    ...
    label1 = new YbLabel(tr("密码设置"), enable);
    label2 = new YbLabel(tr("已禁用"), forbidden);
    label3 = new YbLabel(tr("已禁用"), forbidden);
    ...
    warningLabel = new YbLabel(tr("安全提示：确保您的信息正确并处于最新状态，以防止您的钱包遭受未经授权的访问，并在丢失钱包ID或密码的情况下帮助您恢复钱包的访问权限。"), warning);

...
void MainWidget::setClientModel(ClientModel *clientModel)
{
...
void MainWidget::setWalletModel(WalletModel *walletModel)
{
...
void MainWidget::gotoOverviewPage()
{
    centralWidget->setCurrentWidget(overviewPage);

    exportAction->setEnabled(false);
    toolWidget->setExportButtonEnabled(false);
    disconnect(exportAction, SIGNAL(triggered()), 0, 0);
    disconnect(toolWidget, SIGNAL(exportTriggered()), 0, 0);
}

void MainWidget::gotoHistoryPage()
{
    centralWidget->setCurrentWidget(transactionsPage);

    exportAction->setEnabled(true);
    toolWidget->setExportButtonEnabled(true);
    disconnect(exportAction, SIGNAL(triggered()), 0, 0);
    connect(exportAction, SIGNAL(triggered()), transactionView, SLOT(exportClicked()));
    disconnect(toolWidget, SIGNAL(exportTriggered()), 0, 0);
    connect(toolWidget, SIGNAL(exportTriggered()), transactionView, SLOT(exportClicked()));
}

void MainWidget::gotoAddressBookPage()
{
    ...
    disconnect(toolWidget, SIGNAL(exportTriggered()), 0, 0);
    connect(toolWidget, SIGNAL(exportTriggered()), addressBookPage, SLOT(exportClicked()));
}

void MainWidget::gotoReceiveCoinsPage()
{
    ...
    disconnect(toolWidget, SIGNAL(exportTriggered()), 0, 0);
    connect(toolWidget, SIGNAL(exportTriggered()), receiveCoinsPage, SLOT(exportClicked()));
}

void MainWidget::gotoSendCoinsPage()
{
...
void MainWidget::optionsClicked()
{
...
void MainWidget::distributeDividendsClicked()
{
...
void MainWidget::incomingTransaction(const QModelIndex &parent, int start, int end)
{
...
void MainWidget::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void MainWidget::unlockForMinting(bool status)
{
    if(!walletModel)
        return;
...
void MainWidget::changePassphrase()
{
...
void MainWidget::exportPeercoinKeys()
{
    try {
...
void MainWidget::showNormalIfMinimized()
{
...
void MainWidget::createMainLayout()
{
    ...
    centralWidget->setContentsMargins(1,5,1,0);
    mainLayout->addWidget(statusBar);
}

void MainWidget::createToolWidgetConnections()
{
    connect(toolWidget, SIGNAL(overviewTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(overviewTriggered()), this, SLOT(gotoOverviewPage()));
    connect(toolWidget, SIGNAL(historyTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(historyTriggered()), this, SLOT(gotoHistoryPage()));
    connect(toolWidget, SIGNAL(addressTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(addressTriggered()), this, SLOT(gotoAddressBookPage()));
    connect(toolWidget, SIGNAL(receiveCoinsTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(receiveCoinsTriggered()), this, SLOT(gotoReceiveCoinsPage()));
    connect(toolWidget, SIGNAL(sendCoinsTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(sendCoinsTriggered()), this, SLOT(gotoSendCoinsPage()));
    connect(toolWidget, SIGNAL(messageTriggered()), this, SLOT(showNormalIfMinimized()));
    connect(toolWidget, SIGNAL(messageTriggered()), this, SLOT(gotoMessagePage()));
}

void MainWidget::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void MainWidget::setNumBlocks(int count)
{
...
void MainWidget::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void MainWidget::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void MainWidget::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
...
void MainWidget::handleURI(QString strURI)
{
    gotoSendCoinsPage();
...
void MainWidget::gotoMessagePage()
{
#ifdef FIRST_CLASS_MESSAGING
...
void MainWidget::gotoMessagePage(QString addr)
{
    gotoMessagePage();
